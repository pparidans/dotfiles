...
// Login
javascript:(function () { const LOGIN_PATH = "/web/login"; if (location.pathname !== LOGIN_PATH) { location.pathname = LOGIN_PATH } else { for (let field of ["login", "password"]) { document.forms[0][field].value = "admin" };document.forms[0].submit() } })()
