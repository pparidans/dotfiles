      ...
      archive:
        exclude:
          asd: asd`;
            ...
            chai_1.expect(result[2]).deep.equal(verifyError_1.createDiagnosticWithData(errorMessages_1.ArrayTypeError, 4, 10, 4, 18, vscode_languageserver_1.DiagnosticSeverity.Error, 'yaml-schema: Package', 'https://json.schemastore.org/composer'));
        }));
